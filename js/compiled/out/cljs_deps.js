...
goog.addDependency("../claimr/data/reason_codes.js", ['claimr.data.reason_codes'], ['cljs.core']);
goog.addDependency("../claimr/data/fields.js", ['claimr.data.fields'], ['cljs.core']);
goog.addDependency("../claimr/logic/claim.js", ['claimr.logic.claim'], ['cljs.core']);
goog.addDependency("../claimr/logic/parser.js", ['claimr.logic.parser'], ['claimr.data.fields', 'cljs.core', 'cljs.pprint', 'clojure.string', 'claimr.logic.claim']);
goog.addDependency("../claimr/core.js", ['claimr.core'], ['reagent.core', 'cljs.core', 'cljs_http.client', 'cljs.core.async', 'claimr.data.reason_codes', 'claimr.logic.parser', 'clojure.string', 'claimr.logic.claim', 'reagent.dom']);
...
goog.addDependency("../claimr/state.js", ['claimr.state'], ['cljs.core', 're_frame.core']);
