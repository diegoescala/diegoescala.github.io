...
return (new CustomEvent(event_name,(function (){var obj28546 = {"detail":data};
return obj28546;
})()));
} else {
...
var f = (function (){var pred__28553 = cljs.core._EQ_;
var expr__28554 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__28553.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__28554))){
return ((function (pred__28553,expr__28554){
return (function (p1__28547_SHARP_){
return console.warn(p1__28547_SHARP_);
});
;})(pred__28553,expr__28554))
} else {
if(cljs.core.truth_(pred__28553.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__28554))){
return ((function (pred__28553,expr__28554){
return (function (p1__28548_SHARP_){
return console.debug(p1__28548_SHARP_);
});
;})(pred__28553,expr__28554))
} else {
if(cljs.core.truth_(pred__28553.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__28554))){
return ((function (pred__28553,expr__28554){
return (function (p1__28549_SHARP_){
return console.error(p1__28549_SHARP_);
});
;})(pred__28553,expr__28554))
} else {
return ((function (pred__28553,expr__28554){
return (function (p1__28550_SHARP_){
return console.log(p1__28550_SHARP_);
});
;})(pred__28553,expr__28554))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__28557){
...
var opts = map__28558__$1;
var eval_fn = cljs.core.get.call(null,map__28558__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__28560_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__28562,(0),null);
var v = cljs.core.nth.call(null,vec__28562,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1550771775510
