...
var G__22476 = devtools.prefs.pref.call(null,v);
v = G__22476;
continue;
} else {
return v;
...
}catch (e22479){var _e__21490__auto__ = e22479;
return false;
}})();
...
}catch (e22483){var _e__21490__auto__ = e22483;
return false;
}})();
...
}catch (e22485){var _e__21490__auto__ = e22485;
return false;
}}
}
});
...
var vec__22487 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__22487,(0),null);
var name = cljs.core.nth.call(null,vec__22487,(1),null);
...
return cljs.core.some.call(null,(function (p1__22490_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__22490_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1599595546310
